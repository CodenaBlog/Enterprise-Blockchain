...
banner01
    .addLabel("a") 
    .from('.sc-banner01 .col-left',{x:-400, duration:5},"a")
    .from('.sc-banner01 .col-right',{x:400, duration:5},"a")
    .addLabel("b")
...
safety
    .addLabel("a")
    .to(".sc-safety .group-hori",{x:-515,delay:8,duration:10},"a")
    ...
    .addLabel("b-1")
    .to(".sc-safety .ic-unlock",{autoAlpha:0,duration:10},"b-1")
    .from(".sc-safety .ic-lock",{autoAlpha:0,delay:3,duration:10},"b-1")
    .to(".sc-safety .group-hori .card-item",{autoAlpha:0,duration:5})

    .addLabel("b-2")
    .to(".sc-safety .ic-lock",{autoAlpha:0,duration:10},"b-2")
    .from(".sc-safety .card-text",{autoAlpha:0,delay:5},"b-2")

    .addLabel("c")
    .from(".sc-safety .group-scroll",{autoAlpha:0},"c")
    .from(".sc-safety .group-scroll",{yPercent:100,y:"-200",duration:30,ease: "none"},"c")
    .from(".sc-safety .group-scroll .card-lock",{autoAlpha:0})
    .addLabel("d")
    .to(".sc-safety .group-scroll .card-item:nth-child(2)",{x:-440,duration:5},"d")
    .to(".sc-safety .group-scroll .card-item:nth-child(3)",{x:-880,duration:5},"d")
    .to(".sc-safety .group-scroll .card-item:nth-child(4)",{x:-1320,duration:5},"d")
    .addLabel("e")
...
economy
    .addLabel("a")
    .to(".sc-economy .group-hori",{xPercent:-100,x:"100vw", delay:4, duration:8},"a")
    .from(".sc-economy .group-arrow",{autoAlpha:0,duration:3},"a")
    .from(".sc-economy .group-arrow .fade",{autoAlpha:0,delay:3,duration:5},"a")
